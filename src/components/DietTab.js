    ...
    return (
        <div className="diet-info-container">
            <div className="diet-column">
                <h3>Alergeny</h3>
                <ul>
                    {products.length > 0 ? products.filter((p) => p.is_allergic).map((item, index) => (
                        <ProductCard product={item} key={index} handleRemove={handleRemoveProduct}/>
                ...
                <div className="add-food-form">
                    ...
                    <label>
                        ...
                        <input
                            ...
                            onChange={() => setNewProductData({ ...newProductData, isAllergic: !newProductData.isAllergic })}
                        />
                    </label>
