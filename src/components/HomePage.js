      ...
      >
        ...
        <div className="main-content">
          <div className="main-message">
            Aby twoim zwierzakom żyło się lepiej
          </div>
          ...
          <section className="about-section">
            <h2>O aplikacji</h2>
            <p>
              Nasza aplikacja pomaga właścicielom zwierząt domowych w
              zarządzaniu informacjami o ich pupilach. Dzięki intuicyjnemu
              interfejsowi, wszystkie informacje są zawsze pod ręką.
            </p>
          </section>
        </div>
        <section className="about-section">
